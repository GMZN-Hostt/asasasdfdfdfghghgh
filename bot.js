...
client.on("message", (message) => {
   ...
   if (message.content.startsWith("*new")) {     /// ALPHA CODES
        ...
        if (message.guild.channels.exists("name", "ticket-{message.author.name}" + message.author.id)) return message.channel.send(`You already have a ticket open.`);    /// ALPHA CODES
